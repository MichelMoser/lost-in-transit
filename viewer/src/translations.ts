...
const en = {
  ...
  'app.hint.car': 'Click the map to search from the nearest motorway/expressway junction.',
  ...
  'status.noRoad': 'No motorway/expressway junction found nearby.',
...
const fr: Record<TranslationKey, string> = {
  ...
  'app.hint.car': "Cliquez sur la carte pour chercher depuis l'accès autoroutier/semi-autoroutier le plus proche.",
  ...
  'status.noRoad': 'Aucun accès autoroutier/semi-autoroutier trouvé à proximité.',
...
const de: Record<TranslationKey, string> = {
  ...
  'app.hint.car': 'Auf die Karte klicken, um ab der nächsten Autobahn-/Autostrassen-Anschlussstelle zu suchen.',
  ...
  'status.noRoad': 'Keine Autobahn-/Autostrassen-Anschlussstelle in der Nähe gefunden.',
