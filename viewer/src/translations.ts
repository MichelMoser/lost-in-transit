...
const en = {
  ...
  'app.hint.car': 'Click the map to search from the nearest street.',
  'mode.switch.transit': 'Public transport',
  'mode.switch.car': 'Car',
  'stopSearch.label': 'Or search a stop by name',
  'stopSearch.placeholder': 'Start typing a stop name…',
  'origin.selectedPoint': 'the selected point',
  ...
  'status.loadingRoadNetwork': 'Loading the national road network (~120 MB, first time only)…',
  ...
  'status.car.result': 'Reached {nodes} junctions, {edges} segments drawn ({ms} ms).',
  'status.noRoad': 'No street found nearby.',
  ...
  'legend.motorway': 'Street network',
  'legend.carTip': 'Furthest reachable point',
  'legend.carNote':
    "Routes over Switzerland's public street network — not private driveways, tracks, or footpaths.",
...
const fr: Record<TranslationKey, string> = {
  ...
  'app.hint.car': "Cliquez sur la carte pour chercher depuis la rue la plus proche.",
  'mode.switch.transit': 'Transports publics',
  'mode.switch.car': 'Voiture',
  'stopSearch.label': 'Ou cherchez un arrêt par nom',
  'stopSearch.placeholder': "Tapez le nom d'un arrêt…",
  'origin.selectedPoint': 'le point sélectionné',
  ...
  'status.loadingRoadNetwork': 'Chargement du réseau routier national (~120 Mo, une seule fois)…',
  ...
  'status.car.result': '{nodes} accès atteints, {edges} tronçons affichés ({ms} ms).',
  'status.noRoad': 'Aucune rue trouvée à proximité.',
  ...
  'legend.motorway': 'Réseau routier',
  'legend.carTip': 'Point le plus éloigné atteint',
  'legend.carNote':
    "Calculé sur le réseau routier public suisse — hors accès privés, chemins et sentiers.",
  'isochrone.start': '0 min',
...
const de: Record<TranslationKey, string> = {
  ...
  'app.hint.car': 'Auf die Karte klicken, um ab der nächsten Strasse zu suchen.',
  'mode.switch.transit': 'Öffentlicher Verkehr',
  'mode.switch.car': 'Auto',
  'stopSearch.label': 'Oder Haltestelle nach Namen suchen',
  'stopSearch.placeholder': 'Haltestellennamen eingeben…',
  'origin.selectedPoint': 'dem gewählten Punkt',
  ...
  'status.loadingRoadNetwork': 'Das nationale Strassennetz wird geladen (~120 MB, nur beim ersten Mal)…',
  ...
  'status.car.result': '{nodes} Anschlussstellen erreicht, {edges} Abschnitte gezeichnet ({ms} ms).',
  'status.noRoad': 'Keine Strasse in der Nähe gefunden.',
  ...
  'legend.motorway': 'Strassennetz',
  'legend.carTip': 'Am weitesten erreichter Punkt',
  'legend.carNote':
    'Berechnet über das öffentliche Schweizer Strassennetz — ohne private Zufahrten, Feldwege oder Fusswege.',
  'isochrone.start': '0 Min',
